...
`;
export const VotingPanel = ({ voteRecords, round }) => {
    ...
    return (_jsxs(PanelContainer, { children: [_jsx(Title, { children: "Oylama" }), _jsx(VoteList, { ref: listRef, children: voteRecords && voteRecords.length > 0 ? (voteRecords.map((vote, index) => (_jsxs(VoteItem, { children: [_jsx(VoterName, { children: vote.voterName }), _jsx(Arrow, { children: "\u2192" }), _jsx(TargetName, { children: vote.targetName })] }, index)))) : (_jsx("p", { style: { textAlign: 'center', color: '#a0aec0' }, children: "Bu turda oy kullan\u0131lmad\u0131." })) })] }));
};
